...
function defaultPhrases$1() {
  return Object.keys(defaultPhrases$1).reduce(function (phrases, key) {
    return _extends({}, phrases, defineProperty$1({}, key, propTypes.oneOfType([propTypes.string, propTypes.func, propTypes.node])));
  }, {});
}
...
var GalleryTogglePhotoList = function GalleryTogglePhotoList(_ref) {
  var isOpened = _ref.isOpened,
      onPress = _ref.onPress,
      _ref$phrases = _ref.phrases,
      showLabel = _ref$phrases.showPhotoList,
      hideLabel = _ref$phrases.hidePhotoList;
...
GalleryTogglePhotoList.propTypes = propTypes$1;
...
function calculateThumbnailsOffset(current, bounding) {
  var half = bounding.width / 2 - THUMBNAIL_WIDTH / 2;
  var offset = current * THUMBNAIL_WIDTH + current * THUMBNAIL_OFFSET - half;
  return offset <= 0 ? Math.abs(offset) : offset * -1;
}

var PhotosShape = propTypes.oneOfType([propTypes.arrayOf(propTypes.string.isRequired), propTypes.arrayOf(propTypes.shape({
...
var GalleryCaption = function (_React$PureComponent) {
  inherits(GalleryCaption, _React$PureComponent);

  function GalleryCaption(props) {
    classCallCheck(this, GalleryCaption);

    var _this = possibleConstructorReturn(this, (GalleryCaption.__proto__ || Object.getPrototypeOf(GalleryCaption)).call(this, props));
    ...
    _this.toggleThumbnails = _this.toggleThumbnails.bind(_this);
    _this.setGalleryFigcaptionRef = _this.setGalleryFigcaptionRef.bind(_this);
    return _this;
  }

  createClass(GalleryCaption, [{
    ...
    value: function setGalleryFigcaptionRef(element) {
      ...
      if (element) {
        ...
        var offset = calculateThumbnailsOffset(current, bounding, photos.length);
        this.setState({
    ...
    key: 'renderThumbnail',
    value: function renderThumbnail(photo, index, onClick) {
      var current = this.props.current;


      var className = classnames('thumbnail-button', index === current && 'active');
    ...
    value: function render() {
      ...
      var _state = this.state,
          showThumbnails = _state.showThumbnails,
          thumbnailsOffset = _state.thumbnailsOffset;
      ...
      var hasMoreThanOnePhoto = photos.length > 1;
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                currentPhoto.caption && React.createElement(
                  'h3',
                  { className: 'photo-caption' },
                  currentPhoto.caption
                ),
                currentPhoto.subcaption && React.createElement(
                  'p',
                  { className: 'photo-subcaption' },
                  currentPhoto.subcaption
                )
              ),
              hasMoreThanOnePhoto && React.createElement(
                'div',
    ...
    value: function getDerivedStateFromProps(props, state) {
      if (props.current !== state.current) {
        var offset = calculateThumbnailsOffset(props.current, state.thumbnailsContainerBounding, props.photos.length);
        return {
          thumbnailsOffset: offset
        };
      }
...
GalleryCaption.propTypes = propTypes$2;
GalleryCaption.defaultProps = defaultProps$1;
...
var GalleryControl = function (_React$PureComponent) {
  inherits(GalleryControl, _React$PureComponent);

  function GalleryControl(props) {
    classCallCheck(this, GalleryControl);

    var _this = possibleConstructorReturn(this, (GalleryControl.__proto__ || Object.getPrototypeOf(GalleryControl)).call(this, props));

    _this.onButtonPress = _this.onButtonPress.bind(_this);
    return _this;
  }

  createClass(GalleryControl, [{
    key: 'onButtonPress',
...
GalleryControl.propTypes = propTypes$3;
GalleryControl.defaultProps = defaultProps$2;
...
var GalleryPrevButton = function GalleryPrevButton(_ref) {
...
GalleryPrevButton.propTypes = propTypes$4;
GalleryPrevButton.defaultProps = defaultProps$3;
...
var GalleryNextButton = function GalleryNextButton(_ref) {
  var onPress = _ref.onPress,
      disabled = _ref.disabled;
  return React.createElement(GalleryControl, {
...
GalleryNextButton.propTypes = propTypes$5;
GalleryNextButton.defaultProps = defaultProps$4;
...
var LoadingSpinner = function LoadingSpinner(_ref) {
  var show = _ref.show;
  return show && React.createElement('div', { className: 'loading-spinner' });
};

LoadingSpinner.propTypes = propTypes$6;
LoadingSpinner.defaultProps = defaultProps$5;
...
var GalleryPhoto = function (_React$PureComponent) {
  inherits(GalleryPhoto, _React$PureComponent);

  function GalleryPhoto(props) {
    classCallCheck(this, GalleryPhoto);

    var _this = possibleConstructorReturn(this, (GalleryPhoto.__proto__ || Object.getPrototypeOf(GalleryPhoto)).call(this, props));
  ...
  createClass(GalleryPhoto, [{
    ...
    value: function render() {
      ...
      var className = classnames('gallery-media-photo', 'gallery-media-photo--block', 'gallery-media-cover', loading && 'loading');
...
GalleryPhoto.propTypes = propTypes$7;
GalleryPhoto.defaultProps = defaultProps$6;
...
var Gallery = function (_PureComponent) {
  ...
  function Gallery(props) {
    ...
    _this.onPhotoError = _this.onPhotoError.bind(_this);
    _this.onPhotoPress = _this.onPhotoPress.bind(_this);
    _this.onThumbnailPress = _this.onThumbnailPress.bind(_this);
    _this.onPrevButtonPress = _this.onPrevButtonPress.bind(_this);
    _this.onNextButtonPress = _this.onNextButtonPress.bind(_this);
    return _this;
  }
  ...
  createClass(Gallery, [{
    ...
    value: function render() {
      ...
      var activePhotoIndex = this.state.activePhotoIndex;
      var _state = this.state,
          hidePrevButton = _state.hidePrevButton,
          hideNextButton = _state.hideNextButton,
          controlsDisabled = _state.controlsDisabled;


      var current = this.getPhotoByIndex(activePhotoIndex);

      var hasPhotos = photos.length > 0;
      var hasMoreThanOnePhoto = hasPhotos && photos.length > 1;
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          !hidePrevButton && hasMoreThanOnePhoto && React.createElement(GalleryPrevButton, {
            disabled: controlsDisabled,
            onPress: this.onPrevButtonPress
          }),
          !hideNextButton && hasMoreThanOnePhoto && React.createElement(GalleryNextButton, {
            disabled: controlsDisabled,
        ...
        showThumbnails && current && React.createElement(GalleryCaption, {
          phrases: phrases,
...
Gallery.propTypes = propTypes$8;
Gallery.defaultProps = defaultProps$7;
...
var GalleryCloseButton = function GalleryCloseButton(_ref) {
  ...
  return React.createElement(
    'button',
    { onClick: onPress, className: 'gallery-close', type: 'button', 'aria-busy': false },
    React.createElement(
      'svg',
      _extends({}, buttonProps, { style: buttonStyle }),
      React.createElement('path', { d: CLOSE_PATH, fillRule: 'evenodd' })
    )
  );
};

GalleryCloseButton.propTypes = propTypes$9;
GalleryCloseButton.defaultProps = defaultProps$8;
...
function processPhoto(photo, index) {
  return Object.assign({}, defaultPhotoProps, typeof photo === 'string' ? { number: index + 1, photo: photo } : _extends({}, photo, { number: index + 1 }));
}
...
var ReactBnbGallery = function (_PureComponent) {
  inherits(ReactBnbGallery, _PureComponent);

  function ReactBnbGallery(props) {
    classCallCheck(this, ReactBnbGallery);

    var _this = possibleConstructorReturn(this, (ReactBnbGallery.__proto__ || Object.getPrototypeOf(ReactBnbGallery)).call(this, props));
  ...
  createClass(ReactBnbGallery, [{
    ...
    value: function render() {
      ...
      var _photos = getPhotos(photos);

      var galleryProps = omit_1(this.props, ['onClose', 'leftKeyPressed', 'preloadSize', 'rightKeyPressed', 'show', 'photos']);
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(GalleryCloseButton, { onPress: this.close })
                    ),
                    React.createElement(
                      'div',
                      ...
                      React.createElement(
                        ...
                        React.createElement('div', { className: 'gallery-top--inner' })
                      ),
...
ReactBnbGallery.propTypes = propTypes$a;
ReactBnbGallery.defaultProps = defaultProps$9;
