...
var forbidExtraProps = _interopDefault(require('airbnb-prop-types/src/forbidExtraProps'));
require('airbnb-prop-types/src/mutuallyExclusiveProps');
var nonNegativeInteger = _interopDefault(require('airbnb-prop-types/src/nonNegativeInteger'));
...
function defaultPhrases$1() {
  return Object.keys(defaultPhrases$1).reduce(function (phrases, key) {
    return objectSpread({}, phrases, defineProperty({}, key, PropTypes.oneOfType([PropTypes.string, PropTypes.func, PropTypes.node])));
  }, {});
}
...
var propTypes$1 = forbidExtraProps(objectSpread({}, imagePropTypes, {
...
var defaultProps$1 = objectSpread({}, imageDefaultProps, {
  style: null,
  className: null,
  alt: ''
});
...
function (_PureComponent) {
  ...
  function Image(props) {
    ...
    _this.onLoad = _this.onLoad.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.onError = _this.onError.bind(assertThisInitialized(assertThisInitialized(_this)));
    return _this;
  }
...
var propTypes$2 = forbidExtraProps(objectSpread({}, imagePropTypes, {
  photo: PhotoShape,
  onPress: PropTypes.func
}));

var defaultProps$2 = objectSpread({}, imageDefaultProps, {
  photo: null,
  onPress: noop
});
...
/*#__PURE__*/
function (_PureComponent) {
  inherits(GalleryPhoto, _PureComponent);
  ...
  function GalleryPhoto(props) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(GalleryPhoto).call(this, props));
    _this.onPress = _this.onPress.bind(assertThisInitialized(assertThisInitialized(_this)));
    return _this;
  }
  ...
  createClass(GalleryPhoto, [{
    ...
    value: function renderPhoto() {
      var _this$props = this.props,
          ...
          rest = objectWithoutProperties(_this$props, ["photo"]);
...
/*#__PURE__*/
function (_PureComponent) {
  inherits(GalleryThumbnail, _PureComponent);

  function GalleryThumbnail() {
    classCallCheck(this, GalleryThumbnail);

    return possibleConstructorReturn(this, getPrototypeOf(GalleryThumbnail).apply(this, arguments));
  }

  createClass(GalleryThumbnail, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
...
/*#__PURE__*/
function (_PureComponent) {
  inherits(GalleryTogglePhotoList, _PureComponent);

  function GalleryTogglePhotoList() {
    classCallCheck(this, GalleryTogglePhotoList);

    return possibleConstructorReturn(this, getPrototypeOf(GalleryTogglePhotoList).apply(this, arguments));
  }

  createClass(GalleryTogglePhotoList, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
...
/*#__PURE__*/
function (_PureComponent) {
  inherits(GalleryCaption, _PureComponent);
  ...
  function GalleryCaption(props) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(GalleryCaption).call(this, props));
    ...
    _this.onThumbnailPress = _this.onThumbnailPress.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.setGalleryFigcaptionRef = _this.setGalleryFigcaptionRef.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.setGalleryThubmanilsRef = _this.setGalleryThubmanilsRef.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.toggleThumbnails = _this.toggleThumbnails.bind(assertThisInitialized(assertThisInitialized(_this)));
    return _this;
  }
...
function (_React$PureComponent) {
  ...
  function GalleryControl(props) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(GalleryControl).call(this, props));
    _this.onButtonPress = _this.onButtonPress.bind(assertThisInitialized(assertThisInitialized(_this)));
    return _this;
  }
  ...
  createClass(GalleryControl, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("button", {
        ...
        __self: this
      }, React__default.createElement("svg", _extends_1({}, svgAttributes, {
        style: objectSpread({}, controlStyle, light && controlStyleLight),
        __source: {
          fileName: _jsxFileName$6,
          lineNumber: 78
        },
...
/*#__PURE__*/
function (_PureComponent) {
  inherits(GalleryPrevButton, _PureComponent);

  function GalleryPrevButton() {
    classCallCheck(this, GalleryPrevButton);

    return possibleConstructorReturn(this, getPrototypeOf(GalleryPrevButton).apply(this, arguments));
  }

  createClass(GalleryPrevButton, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          onPress = _this$props.onPress,
...
/*#__PURE__*/
function (_PureComponent) {
  inherits(GalleryNextButton, _PureComponent);

  function GalleryNextButton() {
    classCallCheck(this, GalleryNextButton);

    return possibleConstructorReturn(this, getPrototypeOf(GalleryNextButton).apply(this, arguments));
  }

  createClass(GalleryNextButton, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          onPress = _this$props.onPress,
...
var propTypes$9 = objectSpread({}, galleryPropTypes);

var defaultProps$9 = objectSpread({}, galleryDefaultProps);
...
function (_PureComponent) {
  ...
  function Gallery(props) {
    ...
    _this.hasMoreThanOnePhoto = photos.length > 1;
    _this.move = _this.move.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.prev = _this.prev.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.next = _this.next.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.onPhotoLoad = _this.onPhotoLoad.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.onPhotoError = _this.onPhotoError.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.onPhotoPress = _this.onPhotoPress.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.onThumbnailPress = _this.onThumbnailPress.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.onPrevButtonPress = _this.onPrevButtonPress.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.onNextButtonPress = _this.onNextButtonPress.bind(assertThisInitialized(assertThisInitialized(_this)));
    return _this;
  }
...
var GalleryCloseButton = function GalleryCloseButton(_ref) {
  ...
  return React__default.createElement("button", {
    ...
    __self: this
  }, React__default.createElement("svg", _extends_1({}, buttonProps, {
    style: objectSpread({}, buttonStyle, light && buttonStyleLight),
    __source: {
      fileName: _jsxFileName$a,
      lineNumber: 51
    },
...
function processPhoto(photo, index) {
  return _extends_1({}, defaultPhotoProps, typeof photo === 'string' ? {
    number: index + 1,
    photo: photo
  } : objectSpread({}, photo, {
    number: index + 1
...
var propTypes$b = forbidExtraProps(objectSpread({}, galleryPropTypes, {
...
var defaultProps$b = objectSpread({}, galleryDefaultProps, {
  leftKeyPressed: noop,
  onClose: noop,
...
function (_Component) {
  ...
  function ReactBnbGallery(props) {
    ...
    _this.close = _this.close.bind(assertThisInitialized(assertThisInitialized(_this)));
    _this.onKeyDown = _this.onKeyDown.bind(assertThisInitialized(assertThisInitialized(_this)));
    return _this;
  }
  ...
  createClass(ReactBnbGallery, [{
    ...
    value: function render() {
      ...
      })), React__default.createElement(Gallery, _extends_1({
        phrases: phrases,
        ref: this.gallery,
        photos: photos
      }, galleryProps))))))))));
